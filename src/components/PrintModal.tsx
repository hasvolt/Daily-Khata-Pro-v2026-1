...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .brand-header { position: relative; z-index: 1; display: flex; align-items: center; justify-content: space-between; border-bottom: 3px solid #D97706; padding-bottom: 12px; margin-bottom: 16px; }
    ...
    .user-details { border-left: 3px solid #D97706; background: #f0f9ff; padding: 12px 14px; border-radius: 4px; margin-bottom: 18px; font-size: 11px; color: #0f172a; display: flex; flex-direction: column; gap: 4px; }
  ...
  <div class="user-details">
    <div style="display: flex; justify-content: space-between; gap: 16px;">
      <div style="flex: 1;">
        ...
        ${userDetails.name ? `<div><strong style="color: #D97706; font-size: 12px;">${escapeHtml(userDetails.name)}</strong></div>` : '<div>-</div>'}
